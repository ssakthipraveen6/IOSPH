...
const candidatePaths = [
  path.resolve(__dirname, '../../.runtime/team_rota.json'),
  path.resolve(__dirname, '../database/team_rota.json'),
  path.resolve(__dirname, '../../database/team_rota.json'),
  path.resolve(__dirname, '../../../../../.runtime/team_rota.json'),
  path.resolve(__dirname, '../../../../../database/team_rota.json')
];
const ROTA_FILE = candidatePaths.find(p => fs.existsSync(p)) || candidatePaths[0];
