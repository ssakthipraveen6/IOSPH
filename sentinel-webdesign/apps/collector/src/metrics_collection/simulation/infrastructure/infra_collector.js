...
const baselines = {
  ...
  avi_load_balancer: { 
    ...
    bitbucket_external_ingressFlow: 12.5, bitbucket_external_latency: 52.0,
    otkr_ingressFlow: 3.2, otkr_latency: 68.0,
    performance_center_ingressFlow: 8.4, performance_center_latency: 95.0
  },
  database: { 
    ...
    bitbucket_external_connections: 28, bitbucket_external_tps: 95, bitbucket_external_dbLatency: 14.8,
    otkr_connections: 15, otkr_tps: 42, otkr_dbLatency: 11.2,
    performance_center_connections: 22, performance_center_tps: 65, performance_center_dbLatency: 18.5
  },
  windows_servers: { 
    cpu: 22.4, memory: 48.6, disk: 62.1, status: 'Healthy',
    fortify_cpu: 18.5, fortify_mem: 32.4, iis_threads: 250, iis_sessions: 1420,
    performance_center_cpu: 24.8, performance_center_mem: 18.5
  },
  linux_servers: { 
    ...
    bitbucket_external_cpu: 18.6, bitbucket_external_mem: 7.4,
    otkr_cpu: 12.8, otkr_mem: 5.6
  },
  s3_storage: { 
    ...
    bitbucket_external_space: 320, bitbucket_external_bandwidth: 8.5
  },
  nas_performance: { 
