...
export default function UnifiedHealthMatrix({ 
  ...
  const appItems = [
    { key: 'bitbucket', name: 'Bitbucket Code Repo', host: 'git-stg.internal.corp', port: '443' },
    { key: 'artifactory', name: 'Artifactory Registry', host: 'artifactory-stg.internal.corp', port: '8081' },
    { key: 'nexusiq', name: 'NexusIQ Policy Scanner', host: 'nexus-stg.internal.corp', port: '8083' },
    { key: 'fortify', name: 'Fortify SSC Engine', host: 'fortify-stg.internal.corp', port: '8443' },
    { key: 'teamcity', name: 'TeamCity Build Agents', host: 'teamcity-stg.internal.corp', port: '8111' },
    { key: 'argocd_k8s', name: 'ArgoCD Deployment Hub', host: 'argo-stg.internal.corp', port: '443' },
    { key: 'mcp_server_k8s', name: 'MCP Integration Gateway', host: 'mcp-stg.internal.corp', port: '8080' }
  ];
